...
// Testing the elements of an array - every, some
myArr = [1, 2, -1, 3]
result = myArr.every(value => value > 0)
result = myArr.some(value =>  value > 0)
console.log(result)

// Filtering an array
myArr = [1, 2, -1, 3]
result = myArr.filter(value => value >= 0)
console.log(result)

// Mapping an array
myArr = [1, 2, 3, 4]
result = myArr.map(value => value * 2)
console.log(result)

let lis = myArr.map(value => "<li>" + value + "</li>")
console.log(lis)
let liString = lis.join('')
console.log(liString)
let finalUl = "<ul>" + liString + "</ul>"
finalUl = `<ul>${liString}</ul>`
console.log(finalUl)
...
let objArray = myArr.map(value => ({value: value}))
...
sum = myArr.reduce((accumulator, currentValue) => accumulator + currentValue)
// a = 1, c = 2 => 1 + 2 = 3
// a = 3, c = 3 => 3 + 3 = 6
// a = 6, c = 4 => 6 + 4 = 10
console.log(sum)

sum = myArr.reduce((accumulator, currentValue) => accumulator + currentValue, 10)
// a = 10, c = 1 => 19 + 1 = 11
// a = 11, c = 2 => 11 + 2 = 13
// a = 13, c = 3 => 13 + 3 = 16
// a = 16, c = 4 => 16 + 4 = 20
...
function myFn(){
    console.log('From myFn')
}
myFn()

// Named function expression
let myFn1 = function myFn(){
    console.log('From myFn1')
}
myFn1()

// Anonymous function expression
let myFn2 = function(){
    console.log('From myFn2')
}
myFn2()
...
const person3 = {
    ...
    set fullName(value){
        ...
        this.firstName = parts[0]
        this.lastName = parts[1]
        console.log(parts, this.firstName, this.lastName)
    }
}
try{
    // person3.fullName = true;
    person3.fullName = 'John Smith';
}
catch(e){
    console.log(e)
    alert(e)
...
let anotherLet = 10;
var anotherVar = 20;
const anotherConst = 30;
// var innerHeight = 'something'
...
video.play()//for method calls - the object used to call the method.

video.newProperty = 'value'
video.stop = function(){
    console.log(this)
}
console.log(video)
...
// Video('Movie title')
let videoObj = new Video('Movie title');
...
function Video2(title){
    this.title = title,
    this.tags = ['a', 'b', 'c'],
    this.showTags = function showTags(){
...
let videoObj2 = new Video2('New movie')
videoObj2.showTags();

function Video3(title){
    this.title = title,
    this.tags = ['a', 'b', 'c'],
    this.showTags = function showTags(){
        this.tags.forEach(function(t){
...
let videoObj3 = new Video3('New movie 3')
videoObj3.showTags();

function Video4(title){
    this.title = title,
    this.tags = ['a', 'b', 'c'],
    this.showTags = function showTags(){
        let self = this;
...
let videoObj4 = new Video4('New movie 4')
videoObj4.showTags();
...
// call
playVideo.call({a: 'aa', b: 'bb'}, 'a', 'b')//comma separated
playVideo.call({a: 'cc', b: 'dd'}, 'a', 'b')//comma separated
playVideo.apply({prop1: 1, prop2: 'Two'}, ['c', 'd'])//arguments in an array
playVideo.apply({prop3: 3, prop4: 'Four'}, ['c', 'd'])//arguments in an array

let newPlayVideo = playVideo.bind({c: 'cc'});
newPlayVideo('x', 'y')

function Video5(title){
    this.title = title,
    this.tags = ['a', 'b', 'c'],
    this.showTags = function showTags(){
        this.tags.forEach(function(t){
...
let videoObj5 = new Video5('New movie 5')
videoObj5.showTags();

function Video6(title){
    this.title = title,
    this.tags = ['a', 'b', 'c'],
    this.showTags = function showTags(){
        this.tags.forEach(t => {
...
let videoObj6 = new Video5('New movie 6')
videoObj6.showTags();
